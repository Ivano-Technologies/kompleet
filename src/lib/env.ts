    ...
    if (!result.success) {
      ...
      if (process.env.NODE_ENV === 'development') {
        ...
        return serverSchema.merge(clientSchema).parse({
          ...rawEnv,
          SUPABASE_SERVICE_ROLE_KEY: rawEnv.SUPABASE_SERVICE_ROLE_KEY ?? 'eyJ_dev_placeholder',
          ...
          NEXT_PUBLIC_SUPABASE_ANON_KEY: rawEnv.NEXT_PUBLIC_SUPABASE_ANON_KEY ?? 'eyJ_dev_placeholder',
        });
      }
