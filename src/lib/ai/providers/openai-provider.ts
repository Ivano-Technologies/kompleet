 ...
 * OpenAI Provider
 * ================
 * AI categorization provider using OpenAI GPT models
 */
    ...
    try {
      const response = await this.client.chat.completions.create({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a financial transaction categorization expert for Nigerian businesses. Analyze transactions and categorize them accurately.',
          },
          {
            role: 'user',
            content: prompt,
