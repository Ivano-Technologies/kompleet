        ...
        children: [
          ...
          new Table({
            rows: [
              new TableRow({
                children: [
                  new TableCell({ children: [new Paragraph({ text: 'ASSETS', bold: true })] }),
                  new TableCell({ children: [new Paragraph({ text: 'Amount (₦)', bold: true, alignment: AlignmentType.RIGHT })] })
                ]
              }),
              new TableRow({
                children: [
              ...
              new TableRow({
                children: [
                  new TableCell({ children: [new Paragraph({ text: 'Total Assets', bold: true })] }),
                  new TableCell({ children: [new Paragraph({ text: income.toLocaleString('en-NG'), bold: true, alignment: AlignmentType.RIGHT })] })
                ]
              }),
              new TableRow({
                children: [
                  new TableCell({ children: [new Paragraph({ text: 'LIABILITIES', bold: true })] }),
              ...
              new TableRow({
                children: [
                  new TableCell({ children: [new Paragraph({ text: 'Total Liabilities', bold: true })] }),
                  new TableCell({ children: [new Paragraph({ text: taxLiability.toLocaleString('en-NG'), bold: true, alignment: AlignmentType.RIGHT })] })
                ]
              }),
              new TableRow({
                children: [
                  new TableCell({ children: [new Paragraph({ text: 'NET WORTH', bold: true })] }),
        ...
        children: [
          ...
          new Table({
            rows: [
              ...
              new TableRow({
                children: [
                  new TableCell({ children: [new Paragraph({ text: 'Net Profit After Tax', bold: true })] }),
        ...
        children: [
          ...
          new Table({
            rows: [
              ...
              new TableRow({
                children: [
                  new TableCell({ children: [new Paragraph({ text: 'Taxable Income', bold: true })] }),
                  new TableCell({ children: [new Paragraph({ text: netIncome.toLocaleString('en-NG'), bold: true, alignment: AlignmentType.RIGHT })] })
                ]
              }),
              new TableRow({
              ...
              new TableRow({
                children: [
                  new TableCell({ children: [new Paragraph({ text: 'Tax Payable', bold: true })] }),
                  new TableCell({ children: [new Paragraph({ text: taxLiability.toLocaleString('en-NG'), bold: true, alignment: AlignmentType.RIGHT })] })
                ]
              })
            ],
