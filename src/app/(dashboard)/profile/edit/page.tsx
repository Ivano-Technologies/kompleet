  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      <div>
        <Link
          href="/profile"
          className="inline-flex items-center gap-2 text-sm font-medium text-light-text-secondary dark:text-dark-text-secondary hover:text-light-text-primary dark:hover:text-dark-text-primary transition-colors"
        >
