    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="rounded-lg bg-white p-6 shadow">
          ...
          <p className="mt-2 text-sm text-gray-600">Export all transactions for {selectedYear}</p>
        ...
        <div className="rounded-lg bg-white p-6 shadow">
          ...
          <p className="mt-2 text-sm text-gray-600">Export statements as Word documents</p>
          <div className="mt-4 space-y-2">
            <button
        ...
        <div className="rounded-lg bg-white p-6 shadow">
          ...
          <p className="mt-2 text-sm text-gray-600">Download all data as ZIP archive</p>
          <div className="mt-4">
            <button
