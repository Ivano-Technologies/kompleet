    ...
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
            Calculate withholding tax (WHT) on rental income under Nigeria Tax
            Act 2025
          </p>
        </div>
      </div>
      ...
      <Card className="p-5 rounded-xl mt-6 border-blue-500/20 bg-blue-50 dark:bg-blue-900/10">
        ...
        <p className="text-sm text-blue-700 dark:text-blue-300/80 mb-4">
          ...
          withholding tax on rent. The WHT rate is fetched dynamically from the
