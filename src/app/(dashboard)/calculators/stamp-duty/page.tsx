...
export default function StampDutyCalculator() {
  const [transactionType, setTransactionType] = useState<"transfer" | "lease">(
    "transfer",
  );
  ...
  const calculateStampDuty = () => {
    ...
    try {
      ...
      const calculationResult: StampDutyResult = {
        ...
        amount: amountValue,
        leaseDuration:
          transactionType === "lease" ? parseInt(leaseDuration) : undefined,
        stampDuty,
        applicableRate,
        isExempt,
        exemptionReason,
  ...
  return (
    <div className="container mx-auto p-6 max-w-4xl">
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary">
            Calculate stamp duty on property transactions and lease agreements
            under Nigeria Tax Act 2025
          </p>
        </div>
      </div>
      ...
      <div className="p-5 rounded-xl border border-light-border dark:border-dark-border bg-light-surface dark:bg-dark-surface mb-6">
        <h2 className="text-xl font-semibold mb-1 text-light-text-primary dark:text-dark-text-primary">
          Transaction Details
        </h2>
      ...
      {result && (
        <div
          className={`p-5 rounded-xl border ${result.isExempt ? "border-blue-500 bg-blue-50 dark:bg-blue-900/20" : "border-primary-500 bg-primary-50 dark:bg-primary-900/20"} mb-6`}
        >
          ...
          {result.isExempt ? (
            ...
            <div className="space-y-3 text-light-text-secondary dark:text-dark-text-secondary">
              <div className="flex justify-between">
                ...
                <span className="capitalize font-semibold text-light-text-primary dark:text-dark-text-primary">
            ...
            onClick={() => {
              ...
              generateCalculationPDF({
                ...
                inputs: {
                  ...
                  lease_duration: result.leaseDuration
                    ? `${result.leaseDuration} years`
                    : "N/A",
                },
                results: {
      ...
      <div className="p-5 rounded-xl border border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-dark-surface">
        ...
        <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary mb-4">
          This calculator implements the Nigeria Tax Act 2025 provisions for
          stamp duty on property transactions and leases. Tax rates are fetched
        ...
        <div className="text-sm space-y-2 text-light-text-secondary dark:text-dark-text-secondary">
          ...
          <p>
            ...
            This is an estimate. Consult a qualified Nigerian tax professional
