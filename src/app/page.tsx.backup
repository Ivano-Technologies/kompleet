      ...
      <Section spacing="lg" className="bg-black/100 text-white">
        ...
        <Grid columns={3}>
          ...
          <div className="text-center hover-lift p-8">
            <div className="w-48 h-48 rounded-full icon-gradient-purple flex items-center justify-center mx-auto mb-6">
            ...
            <h3 className="text-3xl font-bold text-white mb-4">Easy</h3>
          ...
          {/* Feature 2: Flexible */}
          <div className="text-center hover-lift p-8">
            <div className="w-48 h-48 rounded-full icon-gradient-pink flex items-center justify-center mx-auto mb-6">
              <svg className="w-24 h-24 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
            </div>
            <h3 className="text-3xl font-bold text-white mb-4">Flexible</h3>
            <ul className="space-y-2 text-gray-400 text-left max-w-xs mx-auto">
          ...
          {/* Feature 3: Secure */}
          <div className="text-center hover-lift p-8">
            <div className="w-48 h-48 rounded-full icon-gradient-blue flex items-center justify-center mx-auto mb-6">
              <svg className="w-24 h-24 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
              </svg>
            </div>
            <h3 className="text-3xl font-bold text-white mb-4">Secure</h3>
            <ul className="space-y-2 text-gray-400 text-left max-w-xs mx-auto">
