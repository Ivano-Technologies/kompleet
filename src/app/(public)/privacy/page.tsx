  ...
  return (
    <div className="min-h-screen bg-light-background dark:bg-dark-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-light-surface dark:bg-dark-surface rounded-lg p-8">
        <h1 className="text-4xl font-bold text-light-text-primary dark:text-dark-text-primary mb-4">Privacy Policy</h1>
        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">1. Introduction</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">2. Information We Collect</h2>
            
            <h3 className="text-xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-3">2.1 Personal Information</h3>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
            ...
            <h3 className="text-xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-3">2.2 Authentication Information</h3>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
            ...
            <h3 className="text-xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-3">2.3 Usage Data</h3>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">3. How We Use Your Information</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">4. Data Storage and Security</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">5. Data Sharing and Disclosure</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">6. Your Privacy Rights</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">7. Data Retention</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">8. Cookies and Tracking Technologies</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">9. Third-Party Services</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">10. Children's Privacy</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">11. Changes to This Privacy Policy</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">12. Contact Us</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">13. Governing Law</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary">
