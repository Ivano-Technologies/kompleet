      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white rounded-lg p-8 mb-8">
          ...
          <div className="bg-gray-900 rounded-lg p-4 text-sm font-mono">
            <p className="text-gray-400 mb-1"># Example request header</p>
        ...
        <div className="bg-white rounded-lg p-8 mb-8">
          ...
          <p className="text-sm text-gray-500 mt-2">All endpoints are relative to this base URL.</p>
        </div>

        <div className="bg-white rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-semibold text-gray-900 mb-6">Key Endpoints</h2>
            ...
            {endpoints.map((ep, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <code className="text-sm text-gray-900 font-mono">{ep.path}</code>
                </div>
        ...
        <div className="bg-white rounded-lg p-8 mb-8">
          ...
          <p className="text-gray-700 mt-4">
            Rate limit headers (<code className="text-sm bg-gray-100 px-1 rounded">X-RateLimit-Limit</code>,{' '}
            <code className="text-sm bg-gray-100 px-1 rounded">X-RateLimit-Remaining</code>) are included in all responses.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg p-8 text-center">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Need help with the API?</h3>
          <p className="text-gray-600 mb-4">Our team is available to help with integration questions.</p>
          <Link
            href="/contact"
