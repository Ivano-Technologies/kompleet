  ...
  return (
    <div className="min-h-screen bg-light-background dark:bg-dark-background py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto bg-light-surface dark:bg-dark-surface rounded-lg p-8">
        ...
        <h1 className="text-4xl font-bold text-light-text-primary dark:text-dark-text-primary mb-4">Cookie Policy</h1>
        <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary mb-8">Last updated: February 12, 2026</p>

        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">1. What Are Cookies</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">2. How We Use Cookies</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">KOMPLEET uses cookies for the following purposes:</p>

            <h3 className="text-xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-3">2.1 Essential Cookies</h3>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
            ...
            <h3 className="text-xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-3">2.2 Functional Cookies</h3>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
            ...
            <h3 className="text-xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-3">2.3 Analytics Cookies</h3>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">3. Third-Party Cookies</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">4. Managing Cookies</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-light-text-primary dark:text-dark-text-primary mb-4">5. Updates to This Policy</h2>
            <p className="text-light-text-secondary dark:text-dark-text-secondary">
