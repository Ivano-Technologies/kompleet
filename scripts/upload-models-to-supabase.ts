...
const SUPABASE_SERVICE_ROLE_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZybGN2a21qdWhuamNpY3d5d3JoIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc2OTE5ODQ2NywiZXhwIjoyMDg0Nzc0NDY3fQ.0hMAghaS-c9PbVtzt0ThmEG1OgYAjFwU4t2wqqKfDsE';
...
async function main() {
  try {
    ...
    console.log('\n💡 Next steps:');
    console.log('  1. Update application code to download models from Supabase');
