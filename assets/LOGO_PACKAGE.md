...
2. **Landscape Format** (16:9) - `marketing/social-media-landscape.png`
   - Twitter/X posts
   - LinkedIn banners
   - YouTube thumbnails
   - 1920 x 1080px

3. **Story Format** (9:16) - `marketing/social-media-story.png`
   - Instagram Stories
   - Facebook Stories
   - WhatsApp Status
   - 1080 x 1920px
...
5. **Presentation Slide** (16:9) - `marketing/presentation-title-slide.png`
...
```
/home/ubuntu/kompleet-web/
├── assets/
│   ├── logo-primary.png          # Primary logo (white bg)
│   ├── logo-inverted.png         # Inverted logo (green bg)
│   ├── LOGO_SPECIFICATIONS.md    # Technical specifications
│   └── LOGO_PACKAGE.md           # This file
├── marketing/
│   ├── social-media-square.png
│   ├── social-media-landscape.png
│   ├── social-media-story.png
│   ├── email-header.png
│   ├── presentation-title-slide.png
│   ├── EMAIL_SIGNATURE.html
│   ├── ONE_PAGER.md
│   └── README.md
└── public/assets/
    ├── logo-primary.png          # Web-accessible primary logo
    └── logo-inverted.png         # Web-accessible inverted logo
```
...
For brand guidelines, additional assets, or usage questions:

**Email:** marketing@kompleet.ng  
**Website:** kompleet.ng  
**Organization:** Ivano Technologies Ltd  
**Location:** Nigeria
